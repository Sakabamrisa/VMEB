...
from ..dataset import ZsreDataset, CounterFactDataset, CaptionDataset, VQADataset, VideoCaptionDataset
...
ALG_DICT = {
    ...
    "FT": apply_ft_to_model, ###使用
    'KN': apply_kn_to_model,
    'MEND': MendRewriteExecutor().apply_to_model,###使用
    'SERAC': SeracRewriteExecutor().apply_to_model,###使用
    'IKE': apply_ike_to_model,###使用
    'FT-Api': apply_ft_api_to_model,###使用
...
MULTIMODAL_DS_DICT = {
    ...
    "vqa": VQADataset,
    "video_caption": VideoCaptionDataset,
}
