...
class BaseTrainer:
    def __init__(self, config, train_set: Dataset, val_set: Dataset):
        ...
        if 'minigpt4' in self.config.model_name.lower() or 'blip2' in self.config.model_name.lower() or 'llava' in self.config.model_name.lower() or 'qwen-vl' in self.config.model_name.lower() or "owl-2" in self.config.model_name.lower() or "qwen2.5-vl" in self.config.model_name.lower() or "video-utr" in self.config.model_name.lower():
